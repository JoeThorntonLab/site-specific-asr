...
sr.altall.seqs.list <- parallel::mclapply(seq_along(sr.results.path), function(i) {
  get.all.altall(sr.results.path[i], sr.alignment.size, "high_second", 0.2)
})

rbd.altall.seqs.list <- parallel::mclapply(seq_along(rbd.results.path), function(i) {
  get.all.altall(rbd.results.path[i], rbd.alignment.size, "high_second", 0.2)
})

ha.altall.seqs.list <- parallel::mclapply(seq_along(ha.results.path), function(i) {
